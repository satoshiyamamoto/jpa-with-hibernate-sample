...
create table order_line(order_id bigint, order_line_id bigint, product_id bigint, quantity integer, amount decimal(8,2), create_at datetime, update_at datetime, primary key(order_id, order_line_id));