insert into product values (1, 'MacBook Pro 13inch Retina Display', 200.00, 'すべてのピクセルに、さらなるパワーを', 1, current_timestamp, current_timestamp);
...
insert into order_line values (1, 2, 2, 2, 100.00, current_timestamp, current_timestamp);
